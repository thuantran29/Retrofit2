...
public class User {
     ...
     * @param fullname
     */
    public User(Integer id, String username, String firstname, String lastname, String city, String country, Integer usertype, String fullname, String userpicUrl, String userpicHttpsUrl, String coverUrl, Integer upgradeStatus, Boolean storeOn, Integer affection, Avatars avatars) {
        super();
        this.id = id;
